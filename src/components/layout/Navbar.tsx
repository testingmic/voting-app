...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-white/80 dark:bg-dark-200/80 backdrop-blur-lg border-b border-gray-200 dark:border-gray-800">
      ...
      {/* Mobile menu */}
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white dark:bg-dark-200 border-t border-gray-200 dark:border-gray-800">
